...
def list_products(
    ...
    return product_service.get_products(db, current_user.id, category, sort_by, sort_order)
...
def get_product(
    ...
    import uuid
    return product_service.get_product(db, uuid.UUID(product_id), current_user.id)
...
def update_product(
    ...
    import uuid
    return product_service.update_product(db, uuid.UUID(product_id), data, current_user.id)
...
def delete_product(
    ...
    import uuid
    product_service.delete_product(db, uuid.UUID(product_id), current_user.id)

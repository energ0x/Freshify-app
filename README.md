...
Перед запуском застосунку оновіть константу `API_URL` у файлі `mobile/src/utils/constants.js`. Замініть дефолтну адресу на ваш локальний IP (наприклад, `192.168.1.100:8000`).
